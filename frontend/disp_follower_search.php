    ...
    <div class="content-element">
            ...
            <div class="content-title">
                <p><?php 
                    ...
                    if(isset($search_term)){
                        echo get_num_search_follower($search_term);
                    }
                    else{
                        echo "0";
                    }?>
        ...
        <div class="enum-element">
            <?php
                ...
                $res = search_within_follower($offset, $search_query);
        ...
        <div class="enum-index">
            ...
            for($i = 3; $i > 0; $i--){
                $offset = ($page - $i-1) * 10;
                if((($offset)>= 0)) {
                    if(!empty(search_within_follower($offset, $search_query))){
                        echo "<a href='disp_follower_search.php?search_query=".$search_query."&page=".($page-$i)."'>".($page-$i)." </a>";
                    }
                }
            }
            
            echo "<a class='act-ind' href='disp_follower_search.php?search_query=".$search_query."&page=".$page."'>".$page." </a> ";
            for($i = 1; $i < 4; $i++){
                $offset = ($page + $i-1) * 10;
                if(!empty(search_within_follower($offset, $search_query))){
                    echo "<a href='disp_follower_search.php?search_query=".$search_query."&page=".($page+$i)."'>".($page+$i)." </a>";
            ...
            if(!empty(search_within_follower($page * 10, $search_query))){
                echo "<a href='disp_follower_search.php?search_query=".$search_query."&page=".($page+1)."'> next</a>";
            }
